...
const defaultGroups = [
  ...
  { id: 'samples', name: 'งานตัวอย่าง', description: 'รับ ส่ง และตรวจกายภาพตัวอย่าง', paths: ['/petitions', '/petitions/new', '/petitions/production/new', '/petitions/:id', '/petitions/:id/edit', '/physical-inspection'], locked: false, sortOrder: 20 },
