...
const GROUPS = [
  ...
  { id: 'lab', name: 'Lab', description: '', paths: ['/record-results', '/daily-check', '/stock-deduction'], locked: false, sortOrder: 1778742461876 },
...
const ROLES = [
  ...
  { id: 'lab', name: 'Lab Analyst', description: 'Sample handling and result entry', locked: false, permissions: ['/record-results', '/daily-check', '/stock-deduction', '/master-items', '/simple-method', '/machines', '/stock'], family: 'lab' },
