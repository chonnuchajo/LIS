...
`;function y(r){const i=r?new Date(r):new Date;return Number.isNaN(i.getTime())?"":i.toLocaleDateString("th-TH",{day:"2-digit",month:"2-digit",year:"numeric"})}function F(r){if(r==null||r==="")return"-";if(Array.isArray(r))return r.map(F).join(", ");if(typeof r=="object"){const i=r;return typeof i.name=="string"?i.name:typeof i.url=="string"?i.url:JSON.stringify(r)}return String(r)}function H(r){if(!r||typeof r!="object")return"-";const i=r;return[i.instrument?String(i.instrument):i.source?String(i.source):"",i.sampleName?String(i.sampleName):""].filter(Boolean).join(" / ")||"-"}function W(r,i){return i.find(t=>t.sampleSeq===r.seq)??i.find(t=>t.batchNo===r.batchNo)??i[0]}function Q(r,i){return i.filter(t=>t.itemSeq===r.seq).flatMap(t=>{var h;const s=(h=t.entries)!=null&&h.length?t.entries:[t.values??{}],o=t.valuesPhase2&&Object.keys(t.valuesPhase2).length?[t.valuesPhase2]:[];return[...s,...o].flatMap((l,m)=>Object.entries(l).filter(([p])=>!p.startsWith("__")&&!p.endsWith("__note")&&!p.endsWith("__source")&&!p.endsWith("__provenance")).map(([p,d])=>({key:`${t.parameterId}-${m}-${p}`,testItem:t.parameterName&&t.parameterName!==p?`${t.parameterName} - ${p}`:t.parameterName||p,value:F(d),refSource:H(l[`${p}__source`])})))})}function se({kind:r,petition:i,labRequests:t=[],qcResults:s=[]}){var u,j,a,g;const o=r==="final",h=o?"FINAL REPORT":"PRE REPORT",l=t[0],m=`${o?"FR":"PR"}-${i.petitionNo}`,p=(l==null?void 0:l.reportCustomerName)||((u=l==null?void 0:l.requester)==null?void 0:u.fullName)||((j=i.submittedBy)==null?void 0:j.name)||"-",d=(l==null?void 0:l.reportAddressType)==="other"?l.reportAddressOther:(a=l==null?void 0:l.requester)==null?void 0:a.address;return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:Y}),e.jsx("div",{className:"rr-root",children:e.jsxs("section",{className:"rr-page",children:[e.jsxs("header",{className:"rr-header",children:[e.jsx("img",{src:k,alt:"ICP Ladda"}),e.jsxs("div",{children:[e.jsx("h1",{children:"บริษัท ไอ ซี พี ลัดดา จำกัด"}),e.jsx("p",{children:"รายงานผลการทดสอบ / Certificate of Analysis"})]}),e.jsxs("div",{className:"rr-meta",children:[e.jsxs("div",{children:["เลขที่รายงาน: ",m]}),e.jsxs("div",{children:["วันที่รายงาน: ",y(o?i.approvedAt:void 0)]}),e.jsxs("div",{children:["เลขคำร้อง: ",i.petitionNo]})]})]}),e.jsx("h2",{children:h}),!o&&e.jsx("div",{className:"rr-watermark",children:"ใช้สำหรับตรวจสอบผลเบื้องต้น"}),e.jsx("table",{className:"rr-info",children:e.jsxs("tbody",{children:[e.jsxs("tr",{children:[e.jsx("th",{children:"ชื่อลูกค้า/หน่วยงาน"}),e.jsx("td",{children:p}),e.jsx("th",{children:"ผู้ยื่นคำร้อง"}),e.jsx("td",{children:((g=i.submittedBy)==null?void 0:g.name)||"-"})]}),e.jsxs("tr",{children:[e.jsx("th",{children:"ที่อยู่รายงานผล"}),e.jsx("td",{colSpan:3,children:d||"-"})]}),e.jsxs("tr",{children:[e.jsx("th",{children:"วันที่รับตัวอย่าง"}),e.jsx("td",{children:y(i.receivedAt||i.sampleSentAt||i.createdAt)}),e.jsx("th",{children:"สถานะรายงาน"}),e.jsx("td",{children:o?"Final":"Preliminary"})]})]})}),i.items.map(x=>{const v=W(x,t),b=Q(x,s);return e.jsxs("div",{className:"rr-sample",children:[e.jsx("table",{className:"rr-info",children:e.jsxs("tbody",{children:[e.jsxs("tr",{children:[e.jsx("th",{children:"ลำดับ"}),e.jsx("td",{children:x.seq}),e.jsx("th",{children:"เลขที่ตัวอย่าง"}),e.jsx("td",{children:x.sampleId||(v==null?void 0:v.labRequestNo)||"-"})]}),e.jsxs("tr",{children:[e.jsx("th",{children:"ชื่อตัวอย่าง"}),e.jsx("td",{colSpan:3,children:x.commonName||x.sampleName})]}),e.jsxs("tr",{children:[e.jsx("th",{children:"Batch/Lot"}),e.jsx("td",{children:x.batchNo||x.lotNo||"-"}),e.jsx("th",{children:"วันที่ผลิต/นำเข้า"}),e.jsx("td",{children:y(x.productionDate)})]})]})}),e.jsxs("table",{className:"rr-results",children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"รายการทดสอบ"}),e.jsx("th",{children:"ผลการทดสอบ"}),e.jsx("th",{children:"Ref. source"})]})}),e.jsx("tbody",{children:b.length?b.map(N=>e.jsxs("tr",{children:[e.jsx("td",{children:N.testItem}),e.jsx("td",{children:N.value}),e.jsx("td",{children:N.refSource})]},N.key)):e.jsx("tr",{children:e.jsx("td",{colSpan:3,className:"rr-empty",children:"ยังไม่พบผลทดสอบของตัวอย่างนี้"})})})]})]},x.seq)}),e.jsxs("footer",{className:"rr-footer",children:[e.jsxs("div",{children:[e.jsx("div",{className:"rr-line"}),e.jsx("p",{children:"ผู้ทดสอบ / Analyst"})]}),e.jsxs("div",{children:[e.jsx("div",{className:"rr-line"}),e.jsx("p",{children:o?"ผู้อนุมัติ / Authorized by":"ผู้ตรวจสอบ / Reviewed by"})]})]}),e.jsxs("p",{className:"rr-note",children:["หมายเหตุ: รายงานนี้แสดงผลเฉพาะตัวอย่างที่นำมาทดสอบเท่านั้น",o?"":" และยังไม่ใช่รายงานผลฉบับสมบูรณ์"]})]})})]})}const Y=`
@page { size: A4 portrait; margin: 0; }
...
`,C=r=>!!(r!=null&&r.trim());function re(r){return!C(r.qcReceivedBy)&&!C(r.labReceivedBy)}function ie(r){return r.status!=="approved"}export{Z as F,ee as P,se as R,re as a,ie as c};
