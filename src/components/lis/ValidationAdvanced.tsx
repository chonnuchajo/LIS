...
export function PrecisionPanel({ settings, onChange, result, dailyLinked = false }: {
...
export function QcPanel({ settings, onChange, result, linkedKinds = [] }: {
