...
export const KPI_META: Record<KpiId, KpiMeta> = {
  ...
  activeTotal:       { label: "งานกำลังทำ",     icon: FlaskConical,  variant: "blue",    drilldownPath: "/petition" },
  labHeadAll:        { label: "งานทั้งหมด",      icon: ClipboardList, variant: "blue",    drilldownPath: "/petition" },
  labHeadWaitingReceive:{ label: "รอรับ",       icon: Hourglass,     variant: "amber",   drilldownPath: "/petition" },
  ...
  returnedTotal:     { label: "งานตีกลับ",       icon: RotateCcw,     variant: "red",     drilldownPath: "/petition" },
