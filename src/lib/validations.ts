...
export const petitionItemSchema = z.object({
  ...
  testItems: z.string().min(1, 'กรุณาเลือกรายการทดสอบ'),
...
export const petitionFormSchema = z.object({
  ...
  storageCondition: z.enum(['room', 'chilled'], { required_error: 'กรุณาเลือกการเก็บรักษาตัวอย่าง' }),
  packageType: z.enum(['plasticBag', 'glassBottle', 'plasticBottle', 'can', 'other'], { required_error: 'กรุณาเลือกภาชนะบรรจุ' }),
