...
function buildRequiredTasks(
  ...
  const isResearchPetition = isResearchAndDevelopmentPetition(petition);
  const scopedParameters = isResearchPetition
    ? parameters.filter((parameter) => parameter.scope === "lab")
    : parameters;
